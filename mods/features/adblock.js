...
let hasShownLibraryTabHiderErrorToast = false;
JSON.parse = function () {
  ...
  try {
    ...
    console.error('Library tab hiding failed:', error);
    if (!hasShownLibraryTabHiderErrorToast) {
      showToast('TizenTube', 'Library tab hiding failed');
      hasShownLibraryTabHiderErrorToast = true;
    }
  }
