...
import { detectAndStorePageFromResponse, detectAndStorePageFromBrowseId, hideVideo, processTileArraysDeep } from './hideWatched.js';
  ...
  if (r?.contents?.tvBrowseRenderer?.content?.tvSecondaryNavRenderer?.sections) {
    for (const section of r.contents.tvBrowseRenderer.content.tvSecondaryNavRenderer.sections) {
      for (const tab of section.tvSecondaryNavSectionRenderer.tabs) {
        ...
        const tabPage = detectAndStorePageFromBrowseId(tabBrowseId);
