...
export const FORCE_DEBUG_LOGGING = true;
export const FORCE_SHORTS_LOGGING = false;
export const FORCE_SHORTS_FILTERING = false;
...
export function getGlobalShortsEnabled(configRead) {
  if (typeof FORCE_SHORTS_FILTERING === 'boolean') return FORCE_SHORTS_FILTERING;
