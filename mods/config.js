...
const defaultConfig = {
  ...
  enableHideMixes: false,
  hideMixesPages: [],
  enableHidePlaylists: false,
  hidePlaylistsPages: [],
  enableHideLives: false,
  hideLivesPages: [],
  enableMinimumViewsFilter: false,
  minimumViewsThreshold: 100000,
  minimumViewsFilterPages: [],
  enableUploadDateFilter: false,
  hideVideosNewerThanDays: null,
  hideVideosOlderThanDays: null,
  uploadDateFilterPages: [],
